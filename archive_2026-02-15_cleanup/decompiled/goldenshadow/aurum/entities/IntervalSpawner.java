...
public class IntervalSpawner {
    ...
    public void ticker() {
        ...
        for (Player p : Bukkit.getOnlinePlayers()) {
            ...
            p.sendMessage(ChatColor.DARK_AQUA + "[" + ChatColor.AQUA + this.getInterval() + ChatColor.DARK_AQUA + "] Iterating through list of size " + ChatColor.AQUA + this.rootList.get(this.index).size());
        }
