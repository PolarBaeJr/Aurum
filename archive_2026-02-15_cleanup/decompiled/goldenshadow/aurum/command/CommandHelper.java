...
public class CommandHelper {
    ...
    public void api(String[] args) {
        if (args.length >= 2) {
            ...
            if (args[1].equalsIgnoreCase("enable_pvp")) {
                Aurum.getPlugin().getConfig().set("pvp", (Object)true);
                Aurum.getPlugin().saveConfig();
            }
            if (args[1].equalsIgnoreCase("disable_pvp")) {
                Aurum.getPlugin().getConfig().set("pvp", (Object)false);
                Aurum.getPlugin().saveConfig();
            }
        }
    }
    ...
    public void editItemSubCommand(String[] args, Player player) {
        ...
        meta.addAttributeModifier(Attribute.GENERIC_ATTACK_SPEED, new AttributeModifier(UUID.randomUUID(), "attack_speed", 0.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HAND));
        if (lore == null) {
        ...
        if (args.length >= 2) {
            if (args[1].equalsIgnoreCase("add_attribute")) {
                ...
                if (args.length == 3 && this.isInteger(args[2])) {
                    ...
                    meta.addAttributeModifier(Attribute.GENERIC_ATTACK_DAMAGE, new AttributeModifier(UUID.randomUUID(), "generic.attackDamage", (double)Integer.parseInt(args[2]), AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HAND));
                ...
                if (args.length == 3 && this.isInteger(args[2])) {
                    ...
                    double newBase = (double)Integer.parseInt(args[2]) + this.itemFactory.itemCreationHelper.getAttributeSum(Attribute.GENERIC_MAX_HEALTH, meta) - oldBase;
                    meta.removeAttributeModifier(Attribute.GENERIC_MAX_HEALTH);
                    meta.addAttributeModifier(Attribute.GENERIC_MAX_HEALTH, new AttributeModifier(UUID.randomUUID(), "health", newBase, AttributeModifier.Operation.ADD_NUMBER, this.itemFactory.itemCreationHelper.parseMaterial(item.getType())));
                ...
                if (args.length == 3 && this.isInteger(args[2])) {
                    ...
                    meta.getPersistentDataContainer().set(key, PersistentDataType.INTEGER, (Object)Integer.parseInt(args[2]));
                ...
                meta.getPersistentDataContainer().set(new NamespacedKey((Plugin)Aurum.getPlugin(), "doorToken"), PersistentDataType.BYTE, (Object)Byte.valueOf("1"));
                item.setItemMeta(meta);
                player.getInventory().setItemInMainHand(item);
                ...
                meta.getPersistentDataContainer().set(new NamespacedKey((Plugin)Aurum.getPlugin(), "doorMiniBossToken"), PersistentDataType.BYTE, (Object)Byte.valueOf("1"));
                item.setItemMeta(meta);
                player.getInventory().setItemInMainHand(item);
                ...
                if (args.length == 3 && this.isInteger(args[2])) {
                    ...
                    meta.getPersistentDataContainer().set(new NamespacedKey((Plugin)Aurum.getPlugin(), "consumableUses"), PersistentDataType.INTEGER, (Object)uses);
            ...
            if (args[2].equalsIgnoreCase("timed_use")) {
                if (args.length == 5 && this.isInteger(args[3]) && (args[4].equalsIgnoreCase("small") || args[4].equalsIgnoreCase("normal") || args[4].equalsIgnoreCase("large"))) {
                    if (player.getInventory().getItemInMainHand().getItemMeta() != null) {
                        ...
                        container.set(key, PersistentDataType.INTEGER, (Object)Integer.parseInt(args[3]));
        ...
        if (args[1].equalsIgnoreCase("event_interaction")) {
            if (args[2].equalsIgnoreCase("single_use") || args[2].equalsIgnoreCase("unlimited_use")) {
                if (args.length > 4 && (args[3].equalsIgnoreCase("small") || args[3].equalsIgnoreCase("normal") || args[3].equalsIgnoreCase("large"))) {
                    ...
                    hitbox.getPersistentDataContainer().set(new NamespacedKey((Plugin)Aurum.getPlugin(), "aurum_event_interaction_command"), PersistentDataType.STRING, (Object)cmd.toString());
            ...
            if (args[2].equalsIgnoreCase("single_use") || args[2].equalsIgnoreCase("unlimited_use")) {
                if (args.length > 4 && (args[3].equalsIgnoreCase("small") || args[3].equalsIgnoreCase("normal") || args[3].equalsIgnoreCase("large"))) {
                    if (player.getInventory().getItemInMainHand().getItemMeta() != null) {
                        ...
                        hitbox.getPersistentDataContainer().set(new NamespacedKey((Plugin)Aurum.getPlugin(), "aurum_conditional_interaction_command"), PersistentDataType.STRING, (Object)cmd.toString());
        ...
        if (args.length >= 2 && args.length <= 3) {
            ...
            if (args[1].equalsIgnoreCase("reset_single_use_interaction")) {
                player.getNearbyEntities(0.5, 0.5, 0.5).stream().filter(x -> x.getScoreboardTags().contains("aurum_pickup_interaction:single_use")).forEach(x -> {
                    ...
                    if (container.has(key, PersistentDataType.STRING) && (data = (String)container.get(key, PersistentDataType.STRING)) != null) {
                        ...
                        container.set(key, PersistentDataType.STRING, (Object)data);
                    }
                });
            ...
            if (args[1].equalsIgnoreCase("xp_multiplier")) {
                ...
                if (args.length == 3 && this.isInteger(args[2]) && (m = Integer.parseInt(args[2])) > 0) {
                    Aurum.getPlugin().getConfig().set("xp-multiplier", (Object)m);
                    Aurum.getPlugin().saveConfig();
            ...
            if (args[1].equalsIgnoreCase("make_door_miniboss_door")) {
                for (Entity e : player.getNearbyEntities(3.0, 3.0, 3.0)) {
                    ...
                    s.getPersistentDataContainer().set(new NamespacedKey((Plugin)Aurum.getPlugin(), "doorIsMiniBossDoor"), PersistentDataType.BYTE, (Object)Byte.valueOf("1"));
                }
        ...
        if (args.length == 2) {
            if (args[1].equalsIgnoreCase("critical_hits")) {
                if (Aurum.getPlugin().getConfig().getBoolean("Critical-hits")) {
                    Aurum.getPlugin().getConfig().set("Critical-hits", (Object)false);
                    Aurum.getPlugin().saveConfig();
                    player.sendMessage(ChatColor.GOLD + "[Aurum] " + ChatColor.YELLOW + "Disabled critical hits!");
                } else {
                    Aurum.getPlugin().getConfig().set("Critical-hits", (Object)true);
                    Aurum.getPlugin().saveConfig();
            ...
            if (args[1].equalsIgnoreCase("kill_command")) {
                if (Aurum.getPlugin().getConfig().getBoolean("kill-command")) {
                    Aurum.getPlugin().getConfig().set("kill-command", (Object)false);
                    Aurum.getPlugin().saveConfig();
                    player.sendMessage(ChatColor.GOLD + "[Aurum] " + ChatColor.YELLOW + "Disabled suicide command!");
                } else {
                    Aurum.getPlugin().getConfig().set("kill-command", (Object)true);
                    Aurum.getPlugin().saveConfig();
            ...
            if (args[1].equalsIgnoreCase("thunder_damage")) {
                if (Aurum.getPlugin().getConfig().getBoolean("Thunder-damage")) {
                    Aurum.getPlugin().getConfig().set("Thunder-damage", (Object)false);
                    Aurum.getPlugin().saveConfig();
                    player.sendMessage(ChatColor.GOLD + "[Aurum] " + ChatColor.YELLOW + "Disabled thunder damage!");
                } else {
                    Aurum.getPlugin().getConfig().set("Thunder-damage", (Object)true);
                    Aurum.getPlugin().saveConfig();
            ...
            if (args[1].equalsIgnoreCase("bank")) {
                if (Aurum.getPlugin().getConfig().getBoolean("Bank")) {
                    Aurum.getPlugin().getConfig().set("Bank", (Object)false);
                    Aurum.getPlugin().saveConfig();
                    player.sendMessage(ChatColor.GOLD + "[Aurum] " + ChatColor.YELLOW + "Disabled larger bank!");
                } else {
                    Aurum.getPlugin().getConfig().set("Bank", (Object)true);
                    Aurum.getPlugin().saveConfig();
            ...
            if (args[1].equalsIgnoreCase("ExperienceSystem")) {
                if (Aurum.getPlugin().getConfig().getBoolean("ExperienceSystem")) {
                    Aurum.getPlugin().getConfig().set("ExperienceSystem", (Object)false);
                    Aurum.getPlugin().saveConfig();
                    player.sendMessage(ChatColor.GOLD + "[Aurum] " + ChatColor.YELLOW + "Disabled Experience System!");
                } else {
                    Aurum.getPlugin().getConfig().set("ExperienceSystem", (Object)true);
                    Aurum.getPlugin().saveConfig();
            ...
            if (args[1].equalsIgnoreCase("RespawnSystem")) {
                if (Aurum.getPlugin().getConfig().getBoolean("RespawnSystem")) {
                    Aurum.getPlugin().getConfig().set("RespawnSystem", (Object)false);
                    Aurum.getPlugin().saveConfig();
                    player.sendMessage(ChatColor.GOLD + "[Aurum] " + ChatColor.YELLOW + "Disabled Respawn System!");
                } else {
                    Aurum.getPlugin().getConfig().set("RespawnSystem", (Object)true);
                    Aurum.getPlugin().saveConfig();
            ...
            if (args[1].equalsIgnoreCase("deny_block_interactions")) {
                if (Aurum.getPlugin().getConfig().getBoolean("deny-blocks")) {
                    Aurum.getPlugin().getConfig().set("deny-blocks", (Object)false);
                    Aurum.getPlugin().saveConfig();
                    player.sendMessage(ChatColor.GOLD + "[Aurum] " + ChatColor.YELLOW + "Disabled block interaction denying!");
                } else {
                    Aurum.getPlugin().getConfig().set("deny-blocks", (Object)true);
                    Aurum.getPlugin().saveConfig();
            ...
            if (args[1].equalsIgnoreCase("deny_openable_interactions")) {
                if (Aurum.getPlugin().getConfig().getBoolean("deny-openable")) {
                    Aurum.getPlugin().getConfig().set("deny-openable", (Object)false);
                    Aurum.getPlugin().saveConfig();
                    player.sendMessage(ChatColor.GOLD + "[Aurum] " + ChatColor.YELLOW + "Disabled openable interaction denying!");
                } else {
                    Aurum.getPlugin().getConfig().set("deny-openable", (Object)true);
                    Aurum.getPlugin().saveConfig();
            ...
            if (args[1].equalsIgnoreCase("advertisement")) {
                if (Aurum.getPlugin().getConfig().getBoolean("advertisement")) {
                    Aurum.getPlugin().getConfig().set("advertisement", (Object)false);
                    Aurum.getPlugin().saveConfig();
                    player.sendMessage(ChatColor.GOLD + "[Aurum] " + ChatColor.YELLOW + "Disabled advertisement!");
                } else {
                    Aurum.getPlugin().getConfig().set("advertisement", (Object)true);
                    Aurum.getPlugin().saveConfig();
            ...
            if (args[1].equalsIgnoreCase("passive_regen")) {
                if (Aurum.getPlugin().getConfig().getBoolean("passive-regen")) {
                    Aurum.getPlugin().getConfig().set("passive-regen", (Object)false);
                    Aurum.getPlugin().saveConfig();
                    player.sendMessage(ChatColor.GOLD + "[Aurum] " + ChatColor.YELLOW + "Disabled passive regeneration!");
                } else {
                    Aurum.getPlugin().getConfig().set("passive-regen", (Object)true);
                    Aurum.getPlugin().saveConfig();
