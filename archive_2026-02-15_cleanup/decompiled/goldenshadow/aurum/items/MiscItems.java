...
public class MiscItems {
    ...
    public ItemStack shardDesert() {
        ...
        NamespacedKey key = new NamespacedKey((Plugin)Aurum.getPlugin(), "ShardID");
        meta.getPersistentDataContainer().set(key, PersistentDataType.INTEGER, (Object)2);
        meta.setLore(lore);
        itemStack.setItemMeta(meta);
        return itemStack;
    }
    ...
    public ItemStack shardEnchantedForest() {
        ...
        NamespacedKey key = new NamespacedKey((Plugin)Aurum.getPlugin(), "ShardID");
        meta.getPersistentDataContainer().set(key, PersistentDataType.INTEGER, (Object)3);
        meta.setLore(lore);
        itemStack.setItemMeta(meta);
        return itemStack;
    }
    ...
    public ItemStack shardLava() {
        ...
        NamespacedKey key = new NamespacedKey((Plugin)Aurum.getPlugin(), "ShardID");
        meta.getPersistentDataContainer().set(key, PersistentDataType.INTEGER, (Object)4);
        meta.setLore(lore);
        itemStack.setItemMeta(meta);
        return itemStack;
    }
