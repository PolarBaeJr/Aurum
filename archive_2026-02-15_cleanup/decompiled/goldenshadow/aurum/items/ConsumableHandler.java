                ...
                if (data != null) {
                    ...
                    for (String[] parsedDatum : parsedData) {
                        ...
                        if (parsedDatum[0].equalsIgnoreCase("PRECISE_HEALTH")) {
                            ...
                            player.setHealth(Math.min(player.getHealth() + (double)amount, Objects.requireNonNull(player.getAttribute(Attribute.GENERIC_MAX_HEALTH)).getValue()));
                        }
                    ...
                    if (uses > 1) {
                        ...
                        container.set(usesKey, PersistentDataType.INTEGER, (Object)(uses - 1));
